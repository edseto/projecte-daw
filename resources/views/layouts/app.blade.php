...
<body>
    <header>
        ...
        <div
            ...
            style="
              background-image: url('http://dawvago.com/assets/img/about/web_banner.jpg');
              height: 450px;
	...
	<footer class="text-center text-white mt-5" style="background-color: #f1f1f1;">
		...
		<div class="text-center text-dark p-3" style="background-color: rgba(0, 0, 0, 0.2);">
			© 2022 Copyright: <a class="text-dark" href="http://dawvago.com/">Dawvago.com</a> - <a class="text-dark" href="{{ route('termes') }}" target="_blank"	 class="nav-item nav-link">Termes i condicions</a>
		</div>
    </footer>
</body>
